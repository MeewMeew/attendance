...
const props = defineProps<Other.DataTable.FacetedFilter.Props>()
...
<template>
  <Popover>
    ...
    <PopoverContent class="w-[200px] p-0" align="start">
      <Command
        :filter-function="
          (val: any[], term) => val.filter((i) => i.label.toLowerCase()?.includes(term))
        "
      >
        ...
        <CommandList>
          ...
          <template v-if="selectedValues.size > 0">
            ...
            <CommandGroup>
              ...
              >
                {{ t('components.datatable.faceted.filter.clear') }}
              </CommandItem>
            </CommandGroup>
          </template>
        </CommandList>
